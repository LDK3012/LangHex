...
public class AuthController implements MicrosoftAuthModel.MicrosoftAuthListener {
    ...
    public void onSignInSuccess(Activity activity, AuthResult authResult) {
        ...
        if (firebaseUser != null) {
            // Lưu hoặc cập nhật thông tin người dùng vào Realtime Database theo cấu trúc mới
    ...
    private void saveMicrosoftUserToDatabase(FirebaseUser firebaseUser) {
        ...
        DatabaseReference microsoftUserNodeRef = databaseReference
                ...
                .child(firebaseUid); // Sử dụng Firebase UID làm key

        String userEmail = firebaseUser.getEmail();
        String userName = firebaseUser.getDisplayName();
        String msGraphId = null;

        // Lấy Microsoft Graph ID và thông tin chính xác hơn từ ProviderData
        ...
        if (msGraphId != null) {
            ...
            // Bạn có thể quyết định không lưu user này nếu msGraphId là bắt buộc
            // hoặc lưu với giá trị null/bỏ qua trường này.
            // Hiện tại, nếu msGraphId là null, trường này sẽ không được thêm.
        }
        microsoftUserData.put("name", userName);

        // Ghi đè toàn bộ object tại Users/MicrosoftUsers/FIREBASE_UID
        // vì chỉ có 3 trường này bạn muốn lưu.
